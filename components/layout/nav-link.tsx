...
export function NavLink({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group relative flex h-11 items-center gap-3 rounded-xl px-3 text-sm font-medium text-muted-foreground transition-[background-color,color,transform] hover:bg-secondary/65 hover:text-foreground",
        active && "bg-primary/10 text-foreground",
      )}
    >
      <span
