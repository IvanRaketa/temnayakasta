...
export const PERSONAL_DATA_PROCESSING_PURPOSE =
  "Обеспечение работы основного интернет-сайта temnayakasta120.ru и запасного домена temnayakasta120.online, перенаправляющего пользователей на основной домен, а также пользовательского сообщества «Тёмная Каста», включая регистрацию и авторизацию пользователей, подтверждение e-mail, восстановление доступа, ведение пользовательских профилей, публикацию пользовательского контента, комментариев и реакций, подписки, уведомления, модерацию, рассмотрение жалоб, обеспечение безопасности сайта, антиспам-защиту, ограничение частоты запросов, администрирование сайта, ведение журналов безопасности, работу внутренней рекламы, техническое обслуживание сайта и исполнение пользовательского соглашения.";
