...
export const PERSONAL_DATA_PROCESSING_PURPOSE =
  "Обеспечение работы интернет-сайта www.temnayakasta120.ru, его дополнительных доменов temnayakasta120.ru, www.temnayakasta120.online и temnayakasta120.online, а также пользовательского сообщества «Тёмная Каста», включая регистрацию и авторизацию пользователей, подтверждение e-mail, восстановление доступа, ведение пользовательских профилей, публикацию пользовательского контента, комментариев и реакций, подписки, уведомления, модерацию, рассмотрение жалоб, обеспечение безопасности сайта, антиспам-защиту, ограничение частоты запросов, администрирование сайта, ведение журналов безопасности, работу внутренней рекламы, техническое обслуживание сайта и исполнение пользовательского соглашения.";
